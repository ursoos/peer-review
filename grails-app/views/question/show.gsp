	...
	<body>
		...
		<div id="show-question" class="content scaffold-show" role="main">
			...
			<ol class="property-list question">
				...
				<g:if test="${questionInstance?.link}">
				<li class="fieldcontain">
					<span id="link-label" class="property-label"><g:message code="question.link.label" default="Link" /></span>
					
						<span class="property-value" aria-labelledby="link-label"><g:fieldValue bean="${questionInstance}" field="link"/></span>
